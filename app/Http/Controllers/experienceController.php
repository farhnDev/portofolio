...
class experienceController extends Controller
{
    ...
    {
        $this->_tipe = 'experience'; // ini aneh juga kenpa merah
    }
    ...
    public function store(Request $request)
    {
        ...
        //route pesan
        return redirect()->route('experience.index')->with('succes', 'Berhasil Menambahkan Data');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        //route pesan
        return redirect()->route('experience.index')->with('succes', 'Berhasil Update Data');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('experience.index')->with('succes', 'Berhasil Hapus');
    }
}
