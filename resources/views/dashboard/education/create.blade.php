            ...
            <div class="row">
                ...
                <div class="col-auto">
                    ...
                    form-control-sm" name="tgl_mulai"
                        placeholder="dd/mm/yy" value="{{ Session::get('tgl_mulai') }}">
                </div>
                <div class="col-auto">Tanggal Akhir</div>
                <div class="col-auto">
                    <input type="date" class="form-control
                    form-control-sm" name="tgl_akhir"
                        placeholder="Tanggal Akhir" value="{{ Session::get('tgl_akhir') }}">
                </div>
            </div>
        </div>
        {{-- <div class="mb-3">
